Only the login is present
The extensions are working fine in the local environment. 
All the Backend process such as API calls are working fine. 
Gemini API is working fit and fine. 
Tasks are being rescheduled by the AI. 
...
The backend logic is present in vercel